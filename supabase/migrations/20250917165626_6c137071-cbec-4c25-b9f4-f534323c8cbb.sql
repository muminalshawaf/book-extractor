...
52',
  ocr_structured = jsonb_set(
    ...
    '{
      "type": "diagram",
      "title": "العقد الأولية للقائمة المترابطة",
      "description": "A series of blue rectangular nodes arranged from left to right, each divided into two sections. The left section contains a numerical data value, and the right section represents a pointer to the next node. The rightmost node has a black dot in its pointer section, indicating a null or end-of-list pointer.",
      "axes_labels": null,
      "data_description": "The diagram shows 4 distinct nodes arranged from left to right. The structure is:\\nNode 5: Data value = 9, Pointer = Node 2\\nNode 3: Data value = 0, Pointer = Node 4\\nNode 4: Data value = 1, Pointer = Node 5\\nNode 2: Data value = -3, Pointer = null (end of list)\\nThe question specifies '\''الرأس = 3'\'' (Head = 3), indicating that Node 3 is the starting point of the linked list to be constructed.",
      "key_values": [
        "Node 5: Data 9, Pointer Node 2",
        "Node 3: Data 0, Pointer Node 4", 
        "Node 4: Data 1, Pointer Node 5",
        "Node 2: Data -3, Pointer null"
      ],
      "numeric_data": null,
      "table_structure": null,
      "educational_context": "These nodes represent a linked list data structure. Students need to arrange them in the correct order based on the pointer relationships, starting from the head node (Node 3). Following the pointers: Node 3 → Node 4 → Node 5 → Node 2 → null, giving the sequence: 0, 1, 9, -3.",
      "estimated": false
    }'::jsonb
  )
