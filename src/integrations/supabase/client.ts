...
export const SUPABASE_URL = "https://ukznsekygmipnucpouoy.supabase.co";
...
export const SUPABASE_FUNCTIONS_BASE = SUPABASE_URL.replace('.supabase.co', '.functions.supabase.co');
